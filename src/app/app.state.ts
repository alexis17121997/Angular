...
export const emprender_internetjs = [
  ...
  },
  {
    ...
    target:"_blank",  
    class:"dropdown-item", 
    href:"https://www.youtube.com/watch?v=y8GESWoleoQ",
    nombre:"Estudia Ing. de Sistemas",
    src:"./assets/proyectos/ricana-tours.svg" ,
},
{
    id:4,
    target:"_blank",  
    class:"dropdown-item", 
    href:"https://www.youtube.com/watch?v=UhzdeGjLJ78",
    nombre:"Curso completo de finanzas",
    src:"./assets/proyectos/ricana-tours.svg" ,
},
];
